...
import 'package:day12_login/view_designated_officer.dart';
...
void main() => runApp(MaterialApp(
      ...
      home: Designated_Officer_list(),
    ));

class Designated_Officer_list extends StatefulWidget {
  const Designated_Officer_list({Key key}) : super(key: key);

  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<Designated_Officer_list> {
  @override
  void initState() {
  ...
  slideComponent(int index) {
    ...
    return InkWell(
        onTap: () => Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    ViewListForDesignatedOfficer())), // Handle your callback
        child:
